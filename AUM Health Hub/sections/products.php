	...
	<?php
		...
		if($_SERVER['REQUEST_METHOD'] == "POST"){
			...
			$addedToCart = $Cart->addToCart($_POST['customerID'],$_POST['productID'],  $_POST['quantityBox']);
			?>
				<script>
	...
	<div class="container my-5">
		...
		<?php foreach($product_item as $item){
			if($item['supplierID'] == 1 && $item['productStock'] == 1){?>
		<div class="row py-2">
			...
			<div class="col-md-6">
				<form method="post">
                        ...
                        <input type="number" name="quantityBox" class = "float-md-left" id="quantityBox">
						<button type="submit" name="cart_submit" class="btn btn-primary float-md-right mx-5">Add to cart</button>
				</form>
	...
	<div class="container my-5">
		...
		<?php foreach($product_item as $item){
			if($item['supplierID'] == 2 && $item['productStock'] == 1){?>
		<div class="row py-2">
			<div class="col-md-6 product">
	...
	<div class="container my-5">
		...
		<?php foreach($product_item as $item){
			if($item['supplierID'] == 3 && $item['productStock'] == 1){?>
		<div class="row py-2">
			<div class="col-md-6 product">
				<a href="#" data-toggle="modal" data-target="#modal1">
					<h4><?php echo $item['productName'] ?></h4>
	...
	<div class="container my-5">
		...
		<?php foreach($product_item as $item){
			if($item['supplierID'] == 4 && $item['productStock'] == 1){?>
		<div class="row py-2">
			<div class="col-md-6 product">
				<a href="#" data-toggle="modal" data-target="#modal1">
					<h4><?php echo $item['productName'] ?></h4>
	...
	<div class="container my-5">
		...
		<?php foreach($product_item as $item){
			if($item['supplierID'] == 5 && $item['productStock'] == 1 ){?>
		<div class="row py-2">
			<div class="col-md-6 product">
				<a href="#" data-toggle="modal" data-target="#modal1">
					<h4><?php echo $item['productName'] ?></h4>
	...
	<div class="container my-5">
		...
		<?php foreach($product_item as $item){
			if($item['supplierID'] == 6 && $item['productStock'] == 1){?>
		<div class="row py-2">
			<div class="col-md-6 product">
				<a href="#" data-toggle="modal" data-target="#modal1">
					<h4><?php echo $item['productName'] ?></h4>
